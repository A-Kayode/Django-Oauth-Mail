...
class AzureSecurityToken:
    def get_token():
        app = ConfidentialClientApplication(client_id=settings.SMTP_OAUTH_AZURE_APP_CLIENT_ID, client_credential=settings.SMTP_OAUTH_AZURE_APP_CLIENT_CREDENTIAL, authority=AZURE_TENANT)
